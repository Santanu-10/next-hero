...
import { RocketIcon, PlayCircleIcon, Check, ChevronUp } from "lucide-react";
  ...
  return (
    <div className={`scroll-to-top ${isVisible ? "visible" : ""}`}>
      ...
      >
        ...
        <ChevronUp className="arrow" aria-hidden="true" />
      </button>
    </div>
  );
};
    ...
    <div className="mobile-menu-main">
      <nav className="nav-main mainmenu-nav mt--30">
        <ul className="mainmenu metismenu" id="mobile-menu-active">
          ...
          <li>
            <Link href="#all-plans" className="main" onClick={onClose}>
              Pricing
            </Link>
          </li>
          <li>
                  ...
                  <div className="content-wrapper">
                    ...
                    >
                      ...
                      <Link
                        ...
                        href="#"
                        className="rts-btn btn-primary btn-white move-right under-line-btn"
                        aria-label="Watch demo of Vaidya Barta clinic management"
                        style={{
                          display: "flex",
                          alignItems: "center",
                          gap: 3,
